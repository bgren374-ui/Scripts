...
if getgenv().turkeyFarmEnabled then
    ...
    local Window = Rayfield:CreateWindow({
        Name = "Unnamed Hub | NFL Universe [Mobile]",
        LoadingTitle = "Loading NFL Universe Script",
        LoadingSubtitle = "by KUnnamed Hub",
        ConfigurationSaving = {
            Enabled = true,
...
Callback = function(Value)
    ...
    SaveManager:SetFolder('NFLUniverse/Unnamed Hub')
    ...
    Library:Notify('Unnamed loaded successfully!', 5)
